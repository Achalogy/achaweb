          ...
          <KBarPositioner>
            <KBarAnimator className="w-1/3 rounded-lg overflow-hidden drop-shadow-2xl bg-white dark:bg-darkMode-900">
              <KBarSearch
                ...
                onChange={(test) => setSearchText(test.target.value)}
                value={searchText}
                className="border-none outline-none p-4 bg-white dark:bg-darkMode-800 dark:text-white text-black w-full text-xl"
              />
