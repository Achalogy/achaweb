...
export default function Project() {
  ...
  return (
    <div className="flex flex-col px-6 py-10 gap-5 drop-shadow-xl rounded-lg bg-white justify-center items-center text-center h-full w-1/4 hover:bg-gray-50 cursor-pointer"
